      ...
      // wait a day
  		try {
			...
			case TROUBLE:
				...
				try {
					if (!scenario.troubledElves.contains(this)) {
					scenario.troubleTickets.acquire(1);
					scenario.troubledElves.add(this);
					if (scenario.troubleTickets.availablePermits() == 0) {
			...
			case AT_SANTAS_DOOR:
				...
				if (count == 3 && scenario.santa.getState() != Santa.SantaState.WOKEN_UP_BY_ELVES) 
